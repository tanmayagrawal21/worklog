...
export function settingsDialog(app) {
  ...
  const body = el('div', {},
    ...
    el('div', { class: 'field' },
      ...
      el('div', { class: 'hint' }, 'Needs Contents: read and write on your data repo. ',
        el('a', { href: 'https://github.com/settings/personal-access-tokens/new', target: '_blank', rel: 'noopener', text: 'Create a fine-grained token' }),
        '. For creating a repo from this app you need a classic token with the ', el('code', { text: 'repo' }), ' scope instead.')),
    el('div', { class: 'field' },
